...
import {
  ...
  BookOpen, ListChecks, Clock, Eye, Languages, Coins, Castle, ChevronDown, ChevronUp, Users, Swords, UserPlus, Star, Award, Lock, ArrowRight, Settings, Monitor, Sun, Moon, Mail, LayoutGrid, House, Folder, FolderPlus, FolderOpen, FolderInput, FilePlus2, FileText, Ellipsis, ChevronRight, BookOpenText, WandSparkles, Send, Copy,
...
const icons = {
  ...
  MapPinned, Search, CircleUserRound, BarChart3, NotebookPen, LogOut, Play, X, Check, Trash2, Pencil, BookOpen, ListChecks, Clock, Eye, Languages, Coins, Castle, ChevronDown, ChevronUp, Users, Swords, UserPlus, Star, Award, Lock, ArrowRight, Settings, Monitor, Sun, Moon, Mail, LayoutGrid, House, Folder, FolderPlus, FolderOpen, FolderInput, FilePlus2, FileText, Ellipsis, ChevronRight, BookOpenText, WandSparkles, Send, Copy,
  Cat, Dog, Bird, Fish, Rabbit, Squirrel, Turtle, Snail, Bug, Ghost, Bot, Skull, Rocket, Crown, Heart, Zap, Flame, Leaf, Mountain, Anchor, Compass, Sword, Shield, Gamepad2, Palette, Music, Pizza, Dices,
};
...
const TAB_OF = { home: 'home', campaign: 'campaign', memos: 'memos', deck: 'memos', study: 'memos', note: 'memos', 'note-edit': 'memos', friends: 'friends', duel: 'friends', settings: 'settings', stats: 'settings', reset: 'settings', confirm: 'settings' };
